...
class BloodPressureDialog extends StatefulWidget {
  ...
  void setAlpha(double a) {
    if (a <= 0)
      throw Exception(
          "$BloodPressureDialog: smoothing factor cannot be 0 or negative");
    if (a > 1)
      throw Exception(
          "$BloodPressureDialog: smoothing factor cannot be greater than 1");
    alpha = a;
  }
...
class _HeartBPPView extends State<BloodPressureDialog> {
  /// Camera controller
